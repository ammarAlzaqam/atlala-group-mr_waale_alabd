...
import locationCh13Img from "../assets/images/locations/13.jpg";
import locationCh20Img from "../assets/images/locations/20.jpg";
...
import locationCh68Img from "../assets/images/locations/68.jpg";
import locationCh70Img from "../assets/images/locations/70.jpg";
...
import locationCh99Img from "../assets/images/locations/99.jpg";
...
import locationCh104Img from "../assets/images/locations/104.jpg";
...
import smartScreenIcon from "../assets/icons/adv/smart-tv.png";
import fieldIcon from "../assets/icons/adv/field.png";
import electricKettleIcon from "../assets/icons/adv/electric-kettle.png";
import electricStoveIcon from "../assets/icons/adv/electric-stove.png";
...
import vipClassification from "../assets/icons/classification/vip.png";

import bed1 from "../assets/icons/chalets/bed/bed1.png";
import bed2s from "../assets/icons/chalets/bed/bed2s.png";
import bed2x from "../assets/icons/chalets/bed/bed2x.png";
import bed3 from "../assets/icons/chalets/bed/bed3.png";
import bed4s from "../assets/icons/chalets/bed/bed4s.png";
import bed4x from "../assets/icons/chalets/bed/bed4x.png";
import bed5 from "../assets/icons/chalets/bed/bed5.png";

import group3 from "../assets/icons/chalets/group/group3.png";
...
export const classificationList = [
  {
    label: "economic",
    title: "اقتصادي",
    icon: economicClassification,
  },
  {
    label: "standard",
    title: "متوسط",
    icon: standardClassification,
  },
  {
    label: "vip",
    title: "مميز",
    icon: vipClassification,
  },
];
...
export const tags = {
  available: {
    ...
    label: "available",
    color:
      "bg-linear-to-t from-green-400/80 to-80% to-green-600/80 text-white!",
  },
  reserved: {
    icon: reservedIcon,
    name: "محجوز",
  ...
  gardenView: {
    ...
    label: "garden view",
    color:
      "bg-linear-to-t from-lime-600/80 via-40% via-lime-700/80 to-70% to-lime-800/80 text-white!",
  },
  aquaView: {
    icon: aquaViewIcon,
    name: "إطلالة اكوا",
...
export const advList = [
  ...
  { label: "field", name: "بجوار الملعب", icon: fieldIcon },
];
...
const adv = {
  ...
  smartTv: { label: "smart_tv", name: "شاشة TV", Icon: smartScreenIcon },
  electricStove: {
    label: "electric_stove",
    name: "بوتجاز كهربائي",
    Icon: electricStoveIcon,
  },
  electricKettle: {
    label: "electric_kettle",
    name: "غلاية كهربائية",
...
export const roomsList = [
  {
    ...
    label: 2,
    icon: room1,
    nofPeople: "3 أفراد وطفلين",
  },
  {
    name: "غرفة و2حمام",
    label: 3,
    icon: room2,
    nofPeople: "4 أفراد وطفلين",
  },
  {
    name: "2غرفة و2حمام",
    label: 4,
    icon: room3,
    nofPeople: "6 أفراد وطفلين",
  },
  {
    name: "3غرفة و2حمام",
    label: 5,
    icon: room4,
    nofPeople: "8 أفراد وطفلين",
  },
];
